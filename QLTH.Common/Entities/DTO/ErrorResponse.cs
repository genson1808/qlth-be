using QLTH.Common.Enums;

namespace QLTH.Common.Entities.DTO
{
    public class ErrorResponse
    {
       #region Property
        ...
        /// <summary>
        /// ID để theo dõi thông tin log: ELK, file log,...
        /// </summary>
        ...
        public ErrorResponse(ErrorCode errorCode, string? userMsg, object? devMsg, string? moreInfo, string? traceId)
        {
            ErrorCode = errorCode;
            UserMsg = userMsg;
            DevMsg = devMsg;
